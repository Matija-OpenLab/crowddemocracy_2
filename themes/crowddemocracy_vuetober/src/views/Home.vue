            ...
            <b-row>
                ...
                <b-col class="col">
                    ...
                    <b-row class="navbar mt-4">
                        ...
                        <b-col>
                            <h1 class="welcome mt-1 ml-5">
                                Vitajte v CrowdDemocracy
                            </h1>
                            <p class="username mb-2 ml-5">
                                Vitaj {{ user.name }}!
                            </p>
                        </b-col>
                    </b-row>
                    <div class="communities mt-3 ml-1">
                        ...
                        >
                            <div @click="navigateToComm(community.id)">
                                ...
                                />
                                <p class="community-count mb-0 mt-3">
