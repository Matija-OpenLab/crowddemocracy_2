            ...
            <b-row class>
                ...
                <b-col class="col .d-flex">
                    ...
                    <b-row class="mt-5">
                        ...
                        <b-col>
                            <a class="back-to-community" href="/home"
                                >Späť do zoznamu komunít</a
                            >
                    ...
                    <b-row class="nav-row">
                        <b-col>
                            <b-button class="nav-button" @click="notVoted"
                                >Nehlasoval som</b-button
                            >
                        </b-col>
                        <b-col>
                            <b-button class="nav-button" @click="latest"
                                >Najnovšie</b-button
                            >
                        </b-col>
                        <b-col>
                            <b-button class="nav-button" @click="popular"
                                >Populárne</b-button
                            >
                        </b-col>
                    </b-row>
                    ...
                    >
                        <div class="posts my-4 mr-4">
                            <div
                                ...
                                :key="post.id"
                            >
                                <p class="question-community mt-5">
                                    {{ post.content }}
                                </p>
                                <span class="voted-num mt-5"
                                    >Zahlasovalo {{ post.total_votes }}</span
                                >
                                <div
                                    class="vote_buttons"
                                    v-if="
                                ...
                                <div v-else>
                                    <b-button
                                        class="change-vote"
                                        @click="changeVote(post.id)"
                                        >ZMENIŤ HLAS</b-button
                                    >
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-else>
                        <h4 class="text-center mt-5">
                            Pridaj sa do komunity, aby si videl hlasovania
                        </h4>
                    </div>
                </b-col>
            </b-row>
    ...
    methods: {
        ...
        notVoted() {
            ...
            function compare(a) {
                if (
                    user.likes.find(
                        vote => parseInt(vote.posts_id) === parseInt(a.id)
                    )
                )
                    return 1;
                return -1;
